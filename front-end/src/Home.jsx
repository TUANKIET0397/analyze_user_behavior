        ...
        <div>
            ...
            <div className="grid grid-cols-3 bg-gray-200 ">
                ...
                <form onSubmit={handleSubmitForm}>
                    ...
                    <button
                        type="submit"
                        className="absolute top-[84px] left-[300px]  rounded-2xl bg-gray-700 px-4 h-8 text-white cursor-pointer"
                    >
                        Dự đoán
                    </button>
                ...
                <div className="col-span-2 pl-20 pr-5">
                    ...
                    <div className="bg-white flex flex-col px-5 py-2 rounded-md">
                        ...
                        <span>
                            Người dùng{" "}
                            <span className="font-bold">{user.name}</span> có xu
                            hướng chi tiêu mạnh vào cuối tuần, tập trung vào các
                            mặt hàng Quần áo. Dự báo chi tiêu sẽ tăng 15% trong
                            tháng tới do nhu cầu nâng cấp thiết bị cá nhân.
                        </span>
                    </div>
